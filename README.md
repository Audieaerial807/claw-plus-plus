...
1. Pick the provider you want to use.
2. Enter your API key if the provider needs one.
...
1. Open the app.
2. Start a new session or continue an old one.
...
4. Set your API key or local model.
5. Open a project or working folder.
6. Ask for help in plain language.
...
6. Ask for help in plain English.
